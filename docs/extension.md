...
1.  `<workspace>/.grok/extensions`
2.  `<home>/.grok/extensions`
...
`<workspace>/.grok/extensions/my-extension/gemini-extension.json`
...
- `contextFileName`: The name of the file that contains the context for the extension. This will be used to load the context from the workspace. If this property is not used but a `GROK.md` file is present in your extension directory, then that file will be loaded.
...
| -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `${extensionPath}`         | The fully-qualified path of the extension in the user's filesystem e.g., '/Users/username/.grok/extensions/example-extension'. This will not unwrap symlinks. |
