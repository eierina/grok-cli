...
const App = ({ config, settings, startupWarnings = [], version }: AppProps) => {
  ...
  useEffect(() => {
    const flashFallbackHandler = async (
      ...
      // Default fallback message for Grok
      message = `⚡ Automatically switching from ${currentModel} to ${fallbackModel} for the remainder of this session.
⚡ This may be due to rate limits or API capacity issues.`;
